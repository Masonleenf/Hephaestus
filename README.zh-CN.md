...
| 2. 独立安装 agentlas-meta-agent | 直接安装到 Claude Code、Codex 或普通 repo | Claude Code、Codex 或系统终端 |
...
如果 Codex 会话已经打开，请运行 `/reload-plugins` 或重新打开一个会话。
...
| 用 slash command 安装 Codex 插件 | Codex 聊天窗口 | `/plugin marketplace add ...`, `/plugin install ...`, `/reload-plugins` |
