...
- **लोकल फ़र्स्ट।** explicit commands → project overrides → आपके local cards।
  Agentlas Hub एक fallback है जो पहली remote use से पहले हमेशा पूछता है, और
  उसे सिर्फ़ redacted keywords मिलते हैं — आपका raw prompt कभी नहीं।
...
- **Receipts और approval gates।** हर routing decision एक receipt लिखता है;
  file writes, cloud calls, payments, publishing, deletion, private data
  export और external tools के लिए हमेशा आपकी मंज़ूरी ज़रूरी है।
