...
[Agentlas Desktop](https://agentlas.cloud/desktop) इस Agent OS का graphical shell है — वही kernel, scheduler और governance subsystems, बस visually संचालित। Desktop 0.6.0 में Hephaestus v1.1.7 engine bundled और pinned आता है; app और उसका kernel आपस में version-lock रहते हैं और एक ही unit के रूप में auto-update होते हैं।
