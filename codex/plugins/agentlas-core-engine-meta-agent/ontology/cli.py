      ...
      <header class="topbar">
        <div class="topbar-inner">
          ...
          <div class="actions">
            ...
            <button class="btn" data-copy="/hephaestus ontology"><span class="icon">C</span>Copy slash</button>
        ...
        <section class="view" data-view="sources">
          <section class="panel">
            <div class="panel-header">
              ...
              <button class="btn primary" data-copy="/hephaestus ontology add ./company-docs --kind company --scope private"><span class="icon">C</span>Copy add</button>
            </div>
...
def command_list_html() -> str:
    commands = [
        ("/hephaestus ontology", "Open or refresh the ontology dashboard"),
        ("/hephaestus ontology add ./company-docs --kind company --scope private", "Register a private source folder"),
