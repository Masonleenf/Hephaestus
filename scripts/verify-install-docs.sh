...
for path in README.md README.ko.md codex/README.md; do
  rg -q 'codex plugin marketplace add agentlas-ai/Hephaestus --ref v0\.2\.9' "$path" || fail "missing Codex marketplace command in $path"
